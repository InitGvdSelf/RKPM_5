...
import 'package:rkpm_5/features/courses/cubit/courses_state.dart';
...
class CoursesView extends StatelessWidget {
          ...
          builder: (context, medsSnapshot) {
            ...
            return Scaffold(
              ...
              floatingActionButton: FloatingActionButton(
                onPressed: () => _addDialog(context, meds),
  ...
  Future<void> _addDialog(BuildContext context, List<Medicine> meds) async {
